...
keyTitle.Text = "KRAISORN HUB - ใส่คีย์เพื่อรัน"; keyTitle.TextColor3 = Color3.new(1,1,1); keyTitle.BackgroundTransparency = 1; keyTitle.Font = "SourceSansBold"; keyTitle.TextSize = 20

local keyInput = Instance.new("TextBox", keyFrame)
keyInput.Size = UDim2.new(0, 240, 0, 40); keyInput.Position = UDim2.new(0.5, -120, 0.4, 0)
keyInput.PlaceholderText = "กรอกรหัสคีย์ที่นี่..."; keyInput.Text = ""; keyInput.BackgroundColor3 = Color3.fromRGB(45, 45, 45); keyInput.TextColor3 = Color3.new(1,1,1); keyInput.Font = "SourceSans"; keyInput.TextSize = 18
Instance.new("UICorner", keyInput)

local submitBtn = Instance.new("TextButton", keyFrame)
submitBtn.Size = UDim2.new(0, 240, 0, 40); submitBtn.Position = UDim2.new(0.5, -120, 0.7, 0)
...
local function CreateClickPoint()
    ...
    local p = Instance.new("TextButton", screenGui); p.Size = UDim2.new(0, 40, 0, 40); p.Position = UDim2.new(0.5, 0, 0.5, 0); p.BackgroundColor3 = Color3.new(1,1,1); p.Text = tostring(#ClickPoints + 1); p.TextColor3 = Color3.new(0,0,0); p.Font = "SourceSansBold"; Instance.new("UICorner", p).CornerRadius = UDim.new(1,0); makeDraggable(p); table.insert(ClickPoints, p)
end
...
acToggleBtn.MouseButton1Click:Connect(function()
    ...
    acToggleBtn.Text = Toggle.AutoClick and "ออโต้คลิก: เปิด" or "ออโต้คลิก: ปิด"; acToggleBtn.BackgroundColor3 = Toggle.AutoClick and Color3.fromRGB(120, 255, 120) or Color3.fromRGB(255, 100, 100)
end)
...
createBtn("ระบบบิน: ปิด", Color3.fromRGB(255, 120, 120), function(self)
    ...
    if Toggle.Fly then
        local char = LocalPlayer.Character or LocalPlayer.CharacterAdded:Wait(); local root = char:WaitForChild("HumanoidRootPart"); local hum = char:WaitForChild("Humanoid")
...
createBtn("ทะลุกำแพง: ปิด", Color3.fromRGB(200, 200, 200), function(self)
    Toggle.NoClip = not Toggle.NoClip; self.Text = Toggle.NoClip and "ทะลุกำแพง: เปิด" or "ทะลุกำแพง: ปิด"; self.BackgroundColor3 = Toggle.NoClip and Color3.fromRGB(120, 255, 120) or Color3.fromRGB(200, 200, 200)
end)
createBtn("เดินเร็ว 100: ปิด", Color3.fromRGB(255, 220, 100), function(self)
    Toggle.Speed = not Toggle.Speed; self.Text = Toggle.Speed and "เดินเร็ว 100: เปิด" or "เดินเร็ว 100: ปิด"; self.BackgroundColor3 = Toggle.Speed and Color3.fromRGB(120, 255, 120) or Color3.fromRGB(255, 220, 100)
end)
createBtn("กระโดด INF: ปิด", Color3.fromRGB(100, 220, 255), function(self)
    Toggle.InfJump = not Toggle.InfJump; self.Text = Toggle.InfJump and "กระโดด INF: เปิด" or "กระโดด INF: ปิด"; self.BackgroundColor3 = Toggle.InfJump and Color3.fromRGB(120, 255, 120) or Color3.fromRGB(100, 220, 255)
end)
