-- [[ KRAISORN HUB V.38: KEY SYSTEM UPDATE + AUTO EAT + BOSS FIGHT ]]
-- OWNER: ไกรสร พิสิษฐ์ 🫡
-- KEY: PISIT112
...
-- [[ ฟังก์ชัน: สู้บอส ID 4 (ใหม่ - ต่อท้ายกระโดด INF) ]]
createBtn("เริ่มสู้บอส (ID: 4)", Color3.fromRGB(255, 150, 50), function(self)
    ...
    if event then
        ...
        self.Text = "✅ ส่งคำสั่งแล้ว"; task.wait(1); self.Text = oldText
    end
end)
